...
const FlujoSan = (props) => {
  ...
  const { tipo, consecutivo } = props;
  const elements = tipo === 39 ?
  ...
  { id: '1-2', source: '1', target: '2', type: 'step', label: 'Asigna saneamiento', arrowHeadType: 'arrowclosed' },
  // { id: '1-3', source: '1', target: '3', type: 'step', label: 'Asigna saneamiento', arrowHeadType: 'arrowclosed' },
  { id: '2-5', source: '2', target: '5', type: 'step', label: 'Envia a revisión borrador', sourceHandle: 'envia', targetHandle: 'envia3', arrowHeadType: 'arrowclosed' },
  // { id: '3-4', source: '3', target: '4', type: 'step', label: 'Envia a revisión', sourceHandle: 'envia', arrowHeadType: 'arrowclosed' },

  { id: '5-2', source: '5', target: '2', type: 'step', label: 'Regresa borrador', sourceHandle: 'regresa3', targetHandle: 'regresa', arrowHeadType: 'arrowclosed' },
  ...
  // { id: '7', type: 'output', data: { label: 'Fin técnico' }, position: { x: 1500, y: 0 }, draggable: false, className: 'nodo', connectable: false, selectable: false, targetPosition: 'left' },
  { id: '8', type: 'output', data: { label: 'Fin jurídico' }, position: { x: 1200, y: 200 }, draggable: false, className: 'nodo', connectable: false, selectable: false, targetPosition: 'left' },
  // { id: '9', data: { label: 'Social' }, position: { x: 300, y: 400 }, draggable: false, className: 'nodo', connectable: false, selectable: false, targetPosition: 'left', sourcePosition: 'right' },
  // { id: '10', type: 'output', data: { label: 'Fin social' }, position: { x: 1500, y: 400 }, draggable: false, className: 'nodo', connectable: false, selectable: false, targetPosition: 'left' },
  ...
  { id: '3-4', source: '3', target: '4', type: 'step', label: 'Envia a revisión borrador', sourceHandle: 'envia', arrowHeadType: 'arrowclosed' },
  ...
  { id: '4-3', source: '4', target: '3', type: 'step', label: 'Regresa borrador', sourceHandle: 'regresa2', targetHandle: 'regresa', arrowHeadType: 'arrowclosed' },
  ...
  React.useEffect(() => {
    ...
    var data = { "id_consulta": "get_flujo_saneamiento", "codigo_bupi": id, "tabla": tipo, "consecutivo": consecutivo }
    servidorPost('/backend/', data).then((response) => {
      console.log("RESPONSE FLUJO", response)
      var data = { "id_consulta": "get_asignaciones_saneamientos", "codigo_bupi": id }
  ...
  return (
    <div>
      <div id="seccion">
        <div id="titulo_seccion">Flujo de saneamiento</div>
        <p id="descripcion_seccion">Sección para ver el estado del saneamiento</p>
